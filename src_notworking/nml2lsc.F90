...
!     ! check that normalizations add to one
  ...
  if (DiffuJrf .LT. 0.0) DiffuJrf = 0.0_fp
  if (PrfSpred.LT.0.0 .or. (DiffuJrf.EQ.0.0 .and. PrfSpred.GT.0.0)) PrfSpred = 0.0_fp
  if (PrfSpred.GT.1.0)  PrfSpred = 1.0_fp
